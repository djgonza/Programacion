...
public class MapPaises
{
    ...
    {
        //mapPaises.forEach((k,v) -> System.out.println("key: "+k+" value:"+v)); 
        
        Set<String> conjuntoClaves = mapPaises.keySet();
        for(String pais: conjuntoClaves)
        {
    ...
    public void print()
    {
        System.out.println(this.mapPaises.toString());
