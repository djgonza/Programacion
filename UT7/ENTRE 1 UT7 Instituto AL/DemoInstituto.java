...
public class DemoInstituto
{
    ...
    public void altaPersonas()
    {
        ...
        instituto.altaPersona(new Profesor("P01", "Pedro", LocalDate.of(1970, Month.NOVEMBER, 1), "Informática", Dia.MARTES));                  
        instituto.altaPersona(new Profesor("P02", "Isabel", LocalDate.of(1972, Month.NOVEMBER, 5), "Informática", Dia.VIERNES));           
        instituto.altaPersona(new Estudiante("E01", "Juan", LocalDate.of(1994, Month.APRIL, 13)));        
        instituto.altaPersona(new Estudiante("E02", "Elena", LocalDate.of(1998, Month.MAY, 28)));   
        instituto.altaPersona(new Profesor("P02", "Isabel", LocalDate.of(1972, Month.NOVEMBER, 5), "Informática", Dia.VIERNES));  
        instituto.altaPersona(new Estudiante("E03", "Luis", LocalDate.of(1997, Month.JANUARY, 6)));
        instituto.altaPersona(new Profesor("P01", "Pedro", LocalDate.of(1970, Month.NOVEMBER, 1), "Informática", Dia.MARTES));
        instituto.altaPersona(new Estudiante("E04", "Ignacio", LocalDate.of(1996, Month.SEPTEMBER, 12)));
        instituto.altaPersona(new Estudiante("E02", "Elena", LocalDate.of(1998, Month.MAY, 28)));
        instituto.altaPersona(new Profesor("P03", "Carmen",  LocalDate.of(1987, Month.FEBRUARY, 6), "Comercio", Dia.MARTES));
    ...
    /**
     *  Mostrar profesores que dan conferencias un determinado
     *  día de la semana
     *
     * 
     */
    ...
    public void demoTotalEstudiantes()
    {
        System.out.println("\nTotal estudiantes en el instituto " + 
            instituto.getNombre() + " : " + instituto.cuantosEstudiantes());
    }
    ...
    public void demoBorrarEstudiantes(int edad)
    {
        ...
        System.out.print("\nSe han borrado estudiantes de edad menor a " + edad + "\n");
        if (borrados.size() != 0)
        {
