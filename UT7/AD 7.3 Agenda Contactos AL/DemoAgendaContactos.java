...
public class DemoAgendaContactos
{
    ...
    public void testAñadirContactos()
    {
        ...
        agenda.añadirContacto(new ContactoPersonal("Pepa Rus","675435672",new Fecha(20, 4, 1970)));
        ...
        agenda.añadirContacto(new ContactoPersonal("Juan García","948112333",new Fecha(20, 4, 1989)));
