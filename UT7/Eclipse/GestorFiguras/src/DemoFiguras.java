...
public class DemoFiguras {
	...
	public void testMayorArea() {
		...
		System.out
				.println("Figura de mayor area : " + f.getClass().getName()
						+ "\n" + String.format("%6.2f", f.calcularArea()));

	}

	public void mostrarMovible() {
		gestor.testMovible();
	}
	...
	*/
	...
	public static void main(String[] args) {
		...
		demo.testAdd();
		demo.gestor.borrarIguales(new Circulo(4, 4, Color.red, 5.2));
