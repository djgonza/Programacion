...
public class GuiListaNumeros extends JFrame  
{
    ...
    /**
     * crear los componenetes y anadirlos el contenedor del frame
     */
    private void crearGui()
    {
    ...
    /**
     * panel que contiene el area de texto
     *  
     */
    private JPanel crearPanelArea()
    {
    ...
    private JPanel crearPanelDerecha()
    {
        ...
        btnSegundoMinimo = new JButton("Segundo minimo");
        panel.add(btnSegundoMinimo);
        btnSegundoMinimo.addActionListener(new ActionListener() {
        ...
        btnBorrarSegundosMinimos = new JButton("Borrar segundos minimos");
        panel.add(btnBorrarSegundosMinimos);
        btnBorrarSegundosMinimos.addActionListener(new ActionListener() {
        ...
        btnDigitosMasGrandes = new JButton("Digitos mas grandes");
        panel.add(btnDigitosMasGrandes);
        btnDigitosMasGrandes.addActionListener(new ActionListener() {
        ...
        btnClear = new JButton("Limpiar area texto");
        panel.add(btnClear);
        btnClear.addActionListener(new ActionListener() {
    ...
    /**
     *  anade un nuevo numero a la lista mostrando el estado actual de la lista
     *  en el area de texto
     *  
     */
    private void  addNumero()
    {
        ...
        else
        {
            try
            {
                ...
                if (!exito)
                {
                    areaTexto.append("\nLista completa, no se ha podido anadir");
                }
                mostrarLista();
    ...
    /**
     *   Muestra en el area de texto el array con los digitos
     *   mas grandes de los elementos de lista
     *  
     */
    private void  digitosMasGrandes()
    {
    ...
    /**
     *   Muestra en el area de texto el valor que corresponde al segundo minimo
     *  
     */
    private void  segundoMinimo()
    {
        ...
        if (lista.estaVacia())
        {
            areaTexto.append("Lista vacia");
        }
        else
        {
            mostrarLista();
            areaTexto.append("\n2 minimo: " + lista.segundoMinimo() + "\n");
        }
        cogerFoco();
    }

    /**
     *  Borra los segundos minimos y muestra en el area de texto la lista
     *  y la cantidad de segundos minimos borrados
     */
    private void  borrarSegundosMinimos()
    {
        clear(); 
    ...
    /**
     * ordena la lista y la muestra en el area de texto
     */
    private void ordenar()
    {
        clear();
    ...
    /**
     * mostrar la lista y su n de elementos en el area de texto
     */
    private void mostrarLista()
    {
        clear();
    ...
    /**
     * Punto entrada de la aplicaicon
     */
    public static void main(String[] args)
    {
        int tam = (int) (Math.random() * 6) +  5;
        ...
        for (int valor:lis)
            lista.addElemento(valor);
        new GuiListaNumeros("Lista de numeros", lista);
